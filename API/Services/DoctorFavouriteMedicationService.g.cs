...
namespace ProjEMR.Services
{
    ...
    public interface IDoctorFavouriteMedicationService
    {
        ...
        Task<List<DoctorFavouriteMedication>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
        ...
        Task<Guid> Create(DoctorFavouriteMedication model);
        ...
        /// <returns>The result of the operation</returns>
        Task<bool> Update(Guid id, DoctorFavouriteMedication updatedEntity);

        /// <summary>Updates a specific doctorfavouritemedication by its primary key</summary>
        /// <param name="id">The primary key of the doctorfavouritemedication</param>
        /// <param name="updatedEntity">The doctorfavouritemedication data to be updated</param>
        /// <returns>The result of the operation</returns>
        Task<bool> Patch(Guid id, JsonPatchDocument<DoctorFavouriteMedication> updatedEntity);
    ...
    public class DoctorFavouriteMedicationService : IDoctorFavouriteMedicationService
    {
        ...
        public DoctorFavouriteMedicationService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["MedicationId_Medication","DoctorId_Doctor"];
        ...
        public async Task<List<DoctorFavouriteMedication>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            var result = await GetDoctorFavouriteMedication(filters, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return result;
        }
        ...
        /// <param name="model">The doctorfavouritemedication data to be added</param>
        /// <returns>The result of the operation</returns>
        public async Task<Guid> Create(DoctorFavouriteMedication model)
        {
            model.Id = await CreateDoctorFavouriteMedication(model);
            return model.Id;
        }
        ...
        public async Task<bool> Update(Guid id, DoctorFavouriteMedication updatedEntity)
        {
            await UpdateDoctorFavouriteMedication(id, updatedEntity);
            return true;
        }
        ...
        /// <returns>The result of the operation</returns>
        /// <exception cref="Exception"></exception>
        public async Task<bool> Patch(Guid id, JsonPatchDocument<DoctorFavouriteMedication> updatedEntity)
        {
            await PatchDoctorFavouriteMedication(id, updatedEntity);
            return true;
        }
        ...
        {
            await DeleteDoctorFavouriteMedication(id);
            return true;
        }
        #region
        private async Task<List<DoctorFavouriteMedication>> GetDoctorFavouriteMedication(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            if (pageSize < 1)
            {
        ...
        private async Task<Guid> CreateDoctorFavouriteMedication(DoctorFavouriteMedication model)
        {
        ...
        private async Task UpdateDoctorFavouriteMedication(Guid id, DoctorFavouriteMedication updatedEntity)
        {
            _dbContext.DoctorFavouriteMedication.Update(updatedEntity);
            await _dbContext.SaveChangesAsync();
        }

        private async Task<bool> DeleteDoctorFavouriteMedication(Guid id)
        {
        ...
        private async Task PatchDoctorFavouriteMedication(Guid id, JsonPatchDocument<DoctorFavouriteMedication> updatedEntity)
        {
