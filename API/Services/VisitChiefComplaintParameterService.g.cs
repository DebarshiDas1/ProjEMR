...
namespace ProjEMR.Services
{
    ...
    public interface IVisitChiefComplaintParameterService
    {
        ...
        Task<List<VisitChiefComplaintParameter>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");
        ...
        Task<Guid> Create(VisitChiefComplaintParameter model);
        ...
        /// <returns>The result of the operation</returns>
        Task<bool> Update(Guid id, VisitChiefComplaintParameter updatedEntity);

        /// <summary>Updates a specific visitchiefcomplaintparameter by its primary key</summary>
        /// <param name="id">The primary key of the visitchiefcomplaintparameter</param>
        /// <param name="updatedEntity">The visitchiefcomplaintparameter data to be updated</param>
        /// <returns>The result of the operation</returns>
        Task<bool> Patch(Guid id, JsonPatchDocument<VisitChiefComplaintParameter> updatedEntity);
    ...
    public class VisitChiefComplaintParameterService : IVisitChiefComplaintParameterService
    {
        ...
        public VisitChiefComplaintParameterService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["ClinicalParameterId_ClinicalParameter","ClinicalParameterValueId_ClinicalParameterValue","UomId_Uom"];
        ...
        public async Task<List<VisitChiefComplaintParameter>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            var result = await GetVisitChiefComplaintParameter(filters, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return result;
        }
        ...
        /// <param name="model">The visitchiefcomplaintparameter data to be added</param>
        /// <returns>The result of the operation</returns>
        public async Task<Guid> Create(VisitChiefComplaintParameter model)
        {
            model.Id = await CreateVisitChiefComplaintParameter(model);
            return model.Id;
        }
        ...
        public async Task<bool> Update(Guid id, VisitChiefComplaintParameter updatedEntity)
        {
            await UpdateVisitChiefComplaintParameter(id, updatedEntity);
            return true;
        }
        ...
        /// <returns>The result of the operation</returns>
        /// <exception cref="Exception"></exception>
        public async Task<bool> Patch(Guid id, JsonPatchDocument<VisitChiefComplaintParameter> updatedEntity)
        {
            await PatchVisitChiefComplaintParameter(id, updatedEntity);
            return true;
        }
        ...
        {
            await DeleteVisitChiefComplaintParameter(id);
            return true;
        }
        #region
        private async Task<List<VisitChiefComplaintParameter>> GetVisitChiefComplaintParameter(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            if (pageSize < 1)
            {
        ...
        private async Task<Guid> CreateVisitChiefComplaintParameter(VisitChiefComplaintParameter model)
        {
        ...
        private async Task UpdateVisitChiefComplaintParameter(Guid id, VisitChiefComplaintParameter updatedEntity)
        {
            _dbContext.VisitChiefComplaintParameter.Update(updatedEntity);
            await _dbContext.SaveChangesAsync();
        }

        private async Task<bool> DeleteVisitChiefComplaintParameter(Guid id)
        {
        ...
        private async Task PatchVisitChiefComplaintParameter(Guid id, JsonPatchDocument<VisitChiefComplaintParameter> updatedEntity)
        {
