...
namespace ProjEMR.Services
{
    ...
    public class PaymentService : IPaymentService
    {
        ...
        public PaymentService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["PatientId_Patient","InvoiceId_Invoice","PaymentModeId_PaymentMode","LocationId_Location"];
