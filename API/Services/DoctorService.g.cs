...
namespace ProjEMR.Services
{
    ...
    public class DoctorService : IDoctorService
    {
        ...
        public DoctorService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["TitleId_Title","OfficialAddressId_Address","LanguageId_Language","GenderId_Gender","StateId_State","CityId_City","CountryId_Country"];
