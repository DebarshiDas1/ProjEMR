...
namespace ProjEMR.Services
{
    ...
    public interface IRequisitionFileService
    {
        ...
        Task<List<RequisitionFile>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");

        /// <summary>Adds a new requisitionfile</summary>
        /// <param name="model">The requisitionfile data to be added</param>
        /// <returns>The result of the operation</returns>
        Task<Guid> Create(RequisitionFile model);
        ...
        /// <returns>The result of the operation</returns>
        Task<bool> Update(Guid id, RequisitionFile updatedEntity);

        /// <summary>Updates a specific requisitionfile by its primary key</summary>
        /// <param name="id">The primary key of the requisitionfile</param>
        /// <param name="updatedEntity">The requisitionfile data to be updated</param>
        /// <returns>The result of the operation</returns>
        Task<bool> Patch(Guid id, JsonPatchDocument<RequisitionFile> updatedEntity);
    ...
    public class RequisitionFileService : IRequisitionFileService
    {
        ...
        public RequisitionFileService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["RequisitionId_Requisition"];
        ...
        public async Task<List<RequisitionFile>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            var result = await GetRequisitionFile(filters, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return result;
        }
        ...
        /// <param name="model">The requisitionfile data to be added</param>
        /// <returns>The result of the operation</returns>
        public async Task<Guid> Create(RequisitionFile model)
        {
            model.Id = await CreateRequisitionFile(model);
            return model.Id;
        }
        ...
        public async Task<bool> Update(Guid id, RequisitionFile updatedEntity)
        {
            await UpdateRequisitionFile(id, updatedEntity);
            return true;
        }
        ...
        /// <returns>The result of the operation</returns>
        /// <exception cref="Exception"></exception>
        public async Task<bool> Patch(Guid id, JsonPatchDocument<RequisitionFile> updatedEntity)
        {
            await PatchRequisitionFile(id, updatedEntity);
            return true;
        }
        ...
        {
            await DeleteRequisitionFile(id);
            return true;
        }
        #region
        private async Task<List<RequisitionFile>> GetRequisitionFile(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            if (pageSize < 1)
            {
        ...
        private async Task<Guid> CreateRequisitionFile(RequisitionFile model)
        {
        ...
        private async Task UpdateRequisitionFile(Guid id, RequisitionFile updatedEntity)
        {
            _dbContext.RequisitionFile.Update(updatedEntity);
            await _dbContext.SaveChangesAsync();
        }

        private async Task<bool> DeleteRequisitionFile(Guid id)
        {
        ...
        private async Task PatchRequisitionFile(Guid id, JsonPatchDocument<RequisitionFile> updatedEntity)
        {
