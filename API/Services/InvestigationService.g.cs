...
namespace ProjEMR.Services
{
    ...
    public interface IInvestigationService
    {
        ...
        Task<List<Investigation>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");

        /// <summary>Adds a new investigation</summary>
        /// <param name="model">The investigation data to be added</param>
        /// <returns>The result of the operation</returns>
        Task<Guid> Create(Investigation model);
        ...
        /// <returns>The result of the operation</returns>
        Task<bool> Update(Guid id, Investigation updatedEntity);

        /// <summary>Updates a specific investigation by its primary key</summary>
        /// <param name="id">The primary key of the investigation</param>
        /// <param name="updatedEntity">The investigation data to be updated</param>
        /// <returns>The result of the operation</returns>
        Task<bool> Patch(Guid id, JsonPatchDocument<Investigation> updatedEntity);
    ...
    public class InvestigationService : IInvestigationService
    {
        ...
        public InvestigationService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<List<Investigation>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            var result = await GetInvestigation(filters, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return result;
        }
        ...
        /// <param name="model">The investigation data to be added</param>
        /// <returns>The result of the operation</returns>
        public async Task<Guid> Create(Investigation model)
        {
            model.Id = await CreateInvestigation(model);
            return model.Id;
        }
        ...
        public async Task<bool> Update(Guid id, Investigation updatedEntity)
        {
            await UpdateInvestigation(id, updatedEntity);
            return true;
        }
        ...
        /// <returns>The result of the operation</returns>
        /// <exception cref="Exception"></exception>
        public async Task<bool> Patch(Guid id, JsonPatchDocument<Investigation> updatedEntity)
        {
            await PatchInvestigation(id, updatedEntity);
            return true;
        }
        ...
        #region
        private async Task<List<Investigation>> GetInvestigation(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            if (pageSize < 1)
            {
        ...
        private async Task<Guid> CreateInvestigation(Investigation model)
        {
        ...
        private async Task UpdateInvestigation(Guid id, Investigation updatedEntity)
        {
            _dbContext.Investigation.Update(updatedEntity);
            await _dbContext.SaveChangesAsync();
        }

        private async Task<bool> DeleteInvestigation(Guid id)
        {
        ...
        private async Task PatchInvestigation(Guid id, JsonPatchDocument<Investigation> updatedEntity)
        {
