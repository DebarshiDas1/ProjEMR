...
namespace ProjEMR.Services
{
    ...
    public class AppointmentService : IAppointmentService
    {
        ...
        public AppointmentService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["PatientId_Patient","InvoiceId_Invoice","VisitId_Visit","LocationId_Location","AppointmentServices_AppointmentService","AccountSettlements_AccountSettlement","AppointmentReminderLogs_AppointmentReminderLog","DayVisits_DayVisit","Notifications_Notification","PaymentGateways_PaymentGateway","TokenManagement_TokenManagement"];
