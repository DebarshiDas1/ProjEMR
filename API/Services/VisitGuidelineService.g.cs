...
namespace ProjEMR.Services
{
    ...
    public interface IVisitGuidelineService
    {
        ...
        Task<List<VisitGuideline>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc");

        /// <summary>Adds a new visitguideline</summary>
        /// <param name="model">The visitguideline data to be added</param>
        /// <returns>The result of the operation</returns>
        Task<Guid> Create(VisitGuideline model);
        ...
        /// <returns>The result of the operation</returns>
        Task<bool> Update(Guid id, VisitGuideline updatedEntity);

        /// <summary>Updates a specific visitguideline by its primary key</summary>
        /// <param name="id">The primary key of the visitguideline</param>
        /// <param name="updatedEntity">The visitguideline data to be updated</param>
        /// <returns>The result of the operation</returns>
        Task<bool> Patch(Guid id, JsonPatchDocument<VisitGuideline> updatedEntity);
    ...
    public class VisitGuidelineService : IVisitGuidelineService
    {
        ...
        public VisitGuidelineService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["VisitId_Visit","PatientId_Patient"];
        ...
        public async Task<List<VisitGuideline>> Get(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            var result = await GetVisitGuideline(filters, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return result;
        }
        ...
        /// <param name="model">The visitguideline data to be added</param>
        /// <returns>The result of the operation</returns>
        public async Task<Guid> Create(VisitGuideline model)
        {
            model.Id = await CreateVisitGuideline(model);
            return model.Id;
        }
        ...
        public async Task<bool> Update(Guid id, VisitGuideline updatedEntity)
        {
            await UpdateVisitGuideline(id, updatedEntity);
            return true;
        }
        ...
        /// <returns>The result of the operation</returns>
        /// <exception cref="Exception"></exception>
        public async Task<bool> Patch(Guid id, JsonPatchDocument<VisitGuideline> updatedEntity)
        {
            await PatchVisitGuideline(id, updatedEntity);
            return true;
        }
        ...
        {
            await DeleteVisitGuideline(id);
            return true;
        }
        #region
        private async Task<List<VisitGuideline>> GetVisitGuideline(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            if (pageSize < 1)
            {
        ...
        private async Task<Guid> CreateVisitGuideline(VisitGuideline model)
        {
        ...
        private async Task UpdateVisitGuideline(Guid id, VisitGuideline updatedEntity)
        {
            _dbContext.VisitGuideline.Update(updatedEntity);
            await _dbContext.SaveChangesAsync();
        }

        private async Task<bool> DeleteVisitGuideline(Guid id)
        {
        ...
        private async Task PatchVisitGuideline(Guid id, JsonPatchDocument<VisitGuideline> updatedEntity)
        {
