...
namespace ProjEMR.Services
{
    ...
    public class PatientService : IPatientService
    {
        ...
        public PatientService(ProjEMRContext dbContext, IFieldMapperService mapper)
        {
        ...
        public async Task<dynamic> GetById(Guid id, string fields)
        {
            ...
            string[] navigationProperties = ["TitleId_Title","GenderId_Gender","AddressId_Address","BloodGroup_BloodGroup","LocationId_Location","PatientNotes_PatientNotes","MembershipId_Membership","PatientAllergy_PatientAllergy","PatientStatistics_PatientStatistics","PatientCategories_PatientCategory","PatientComorbidities_PatientComorbidity","ContactMembers_ContactMember","PatientPayors_PatientPayor","PatientLifeStyle_PatientLifeStyle","PatientEnrollmentLinks_PatientEnrollmentLink","PatientHospitalisationHistories_PatientHospitalisationHistory","PregnancyHistories_PregnancyHistory","PatientMedicalHistoryNotes_PatientMedicalHistoryNote","PatientPregnancies_PatientPregnancy","StateId_State","CityId_City","CountryId_Country"];
